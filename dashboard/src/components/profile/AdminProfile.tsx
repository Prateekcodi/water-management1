...
const AdminProfile: React.FC = () => {
  ...
  const handleDeleteUser = async (userId: string) => {
    if (!window.confirm('Are you sure you want to delete this user? This will also delete all their homes and data.')) return
  ...
  const handleDeleteHome = async (homeId: string) => {
    if (!window.confirm('Are you sure you want to delete this home? This will also delete all associated data.')) return
